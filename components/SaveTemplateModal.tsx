    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 animate-fade-in-up">
            <div className="bg-sky-800 rounded-2xl shadow-2xl p-8 max-w-md w-full" role="dialog" aria-modal="true" aria-labelledby="save-modal-title">
                ...
                <p className="text-slate-300 mb-6">Dale un nombre a esta plantilla para reutilizar la estructura y el contenido de tu borrador en futuros proyectos.</p>
                <form onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="templateName" className="block text-sm font-medium text-slate-200">Nombre de la Plantilla</label>
