...
const ApiKeySetup: React.FC<ApiKeySetupProps> = ({ reason }) => {
  ...
  return (
    <div className="min-h-screen bg-sky-900 text-slate-200 font-sans p-4 sm:p-6 md:p-8 flex items-center justify-center">
      <div className="max-w-3xl w-full bg-sky-800 p-8 rounded-lg shadow-2xl border border-red-500/50 text-center animate-fade-in-up">
        ...
        <h1 className="text-3xl font-bold text-red-400 mb-4">{title}</h1>
        <p className="text-lg text-slate-300 mb-6">
          {description}
        </p>
        
        {isInvalid && (
          <div className="text-left bg-sky-700/30 p-6 rounded-md border border-sky-600 mb-6">
            <h2 className="text-xl font-semibold text-slate-100 mb-3">Guía de Solución de Problemas</h2>
            <ul className="list-disc list-inside space-y-3 text-slate-300">
              ...
              <li>
                <strong>Consulta la documentación:</strong> Para más ayuda, visita la <a href="https://ai.google.dev/gemini-api/docs/troubleshooting" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300 underline">guía oficial de solución de problemas</a>.
              </li>
            </ul>
          </div>
        )}

        <div className="text-left bg-sky-700 p-6 rounded-md border border-sky-600">
          <h2 className="text-xl font-semibold text-slate-100 mb-3">Pasos para Configurar tu API Key:</h2>
          <ol className="list-decimal list-inside space-y-3 text-slate-300">
            <li>
              Obtén una nueva API key desde <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300 underline">Google AI Studio</a>.
            </li>
            <li>
              En el panel de configuración de esta herramienta, busca la sección de "Secret Keys" o "Variables de Entorno".
            </li>
            <li>
              Crea o actualiza el "secret" con el nombre exacto <code className="bg-sky-900 text-sky-300 px-2 py-1 rounded-md text-sm font-mono">API_KEY</code>.
            </li>
            <li>
