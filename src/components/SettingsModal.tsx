...
const SettingsModal: React.FC<SettingsModalProps> = ({ currentSettings, onSave, onClose }) => {
    ...
    const handleGoogleSearchChange = (checked: boolean) => {
        ...
        if (checked) {
            setUseThinkingMode(false);
            setModel('gemini-3-flash-preview'); // Default to Flash for search
        }
    };
    ...
    const handleThinkingModeChange = (checked: boolean) => {
        ...
        if (checked) {
            setUseGoogleSearch(false);
            setModel('gemini-3.1-pro-preview'); // Default to Pro for thinking
        }
    };
                ...
                <div className="space-y-8">
                    ...
                    <div className="border-t border-sky-700 pt-8">
                     ...
                     <div className="border-t border-sky-700 pt-8">
                        ...
                        <p className="mt-2 text-sm text-slate-400">
                           Activa esta opción para que la IA utilice <span className="font-semibold text-slate-300">Gemini 3.1 Pro</span> con su máxima capacidad de razonamiento. Ideal para problemas complejos.
                    ...
                    <div className="border-t border-sky-700 pt-8">
                        ...
                        <div className="space-y-4">
                         ...
                         <p className="mt-2 text-sm text-slate-400">
                            {useThinkingMode 
                                ? 'El Modo de Pensamiento Profundo utiliza Gemini 3.1 Pro. Selecciona otro modelo si deseas desactivar este modo.' 
                                : useGoogleSearch
