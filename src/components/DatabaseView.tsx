...
import { Download, Upload, ArrowLeft, Trash2, Layout, Database, TrendingUp, TrendingDown, Clock } from 'lucide-react';
    ...
    <div className="animate-fade-in-up w-full max-w-5xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
            ...
            <button
                onClick={onBack}
                className="px-6 py-2 bg-slate-600 text-slate-100 font-bold rounded-lg hover:bg-slate-500 transition-all flex items-center gap-2"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-sky-800/40 border border-sky-700 p-4 rounded-xl text-center">
              <Database className="w-5 h-5 text-slate-500 mx-auto mb-2" />
      ...
      <div className="mt-12 p-6 bg-sky-900/30 rounded-xl border border-sky-700/50">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
              Tus datos se guardan de forma segura en la nube (Firestore). Esto permite que tus leads y tú accedan a los proyectos desde cualquier dispositivo una vez autenticados con Google. Te recomendamos usar la función de <strong>Backup</strong> periódicamente para descargar una copia de tus proyectos de seguridad.
          </p>
      </div>
    </div>
  );
